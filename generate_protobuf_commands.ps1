...
$CppCommandHeaderTemplateFile = "$ProtobufSourceDir/CommandClass.h.template"
$CppCommandClassTemplateFile = "$ProtobufSourceDir/CommandClass.cpp.template"
$CppCommandEnumTemplateFile = "$ProtobufSourceDir/CommandsEnum.h.template"
$CppCommandEnumFile = "$CppOutputCommandDir/$CommandEnumFileName$CppHeaderFileExtension"
$CppCommandBaseTypeDefTemplateFile = "$ProtobufSourceDir/menrva_command_base_types.template"
$CppCommandBaseHeaderTemplateFile = "$ProtobufSourceDir/menrva_command_base.h.template"
$CppCommandBaseClassTemplateFile = "$ProtobufSourceDir/menrva_command_base.cpp.template"
