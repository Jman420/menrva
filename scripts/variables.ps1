...
# Directories
$RepoRootDir = ".."
$RepoLibsDir = "$RepoRootDir/libs"
$RepoProjectDir = "$RepoRootDir/menrva"
$RootAppDir = "$RepoProjectDir/app"
...
$MagiskModuleDir = "$RepoLibsDir/MMT-Extended"
...
$AppArtifact = "$ArtifactsRootDir/$ModuleApkFileName"
...
$ModuleStartupScriptFile = "$ModuleFilesDir/menrva_startup.sh"
