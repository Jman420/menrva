...
class Engine_GetVersion_Request :
 ...
 public:
  ...
  inline void Swap(Engine_GetVersion_Request* other) {
...
class Engine_GetVersion_Response :
 ...
 public:
  ...
  inline void Swap(Engine_GetVersion_Response* other) {
    if (other == this) return;
    InternalSwap(other);
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Engine_GetVersion_Response::_internal_major() const {
  return major_;
}
...
inline void Engine_GetVersion_Response::_internal_set_major(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Engine_GetVersion_Response::_internal_minor() const {
  return minor_;
}
...
inline void Engine_GetVersion_Response::_internal_set_minor(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Engine_GetVersion_Response::_internal_patch() const {
  return patch_;
}
...
inline void Engine_GetVersion_Response::_internal_set_patch(::PROTOBUF_NAMESPACE_ID::int32 value) {
